...
public class LogManager {
	...
	private static synchronized Logger getLogger() {
		if (logger == null) {
			logger = Logger.getLogger("pi-monitor");
			try {
				String logFile = System.getProperty("user.home") + File.separator + "logs" + File.separator + "pi-monitor.log";
